...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('invoice_invoice', 'status')


    def backwards(self, orm):
        
        # Adding field 'Invoice.status'
        db.add_column('invoice_invoice', 'status', self.gf('django.db.models.fields.CharField')(default='draft', max_length=20), keep_default=False)

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invoice.draft'
        db.add_column('invoice_invoice', 'draft', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Invoice.draft'
        db.delete_column('invoice_invoice', 'draft')

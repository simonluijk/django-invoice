...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Invoice.due_date'
        raise RuntimeError("Cannot reverse this migration. 'Invoice.due_date' and its values cannot be restored.")
